...
| :-------------: |:-------------:| :-------------:| :-------------:|
| `network` | String | Yes | The litecoin network specification. 
...
await litecoinjs.newTransaction({
    network: 'normal',
    address: 'MM1XvzCfqggK9aipkqpNyEEiqPNAqD5W11',
    change_address: 'MM1XvzCfqggK9aipkqpNyEEiqPNAqD5W11',
...
Once executed you will receive a reply with the raw transaction ready to be broadcasted to the litecoin network. See the example below. 
